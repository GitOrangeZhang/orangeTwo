...
<body>
    ...
    <ul class="imglist">
	    <c:forEach items="${cars }" var="car" varStatus="sta">
    		...
    		<li class="selected" style="width: 120px;height: 90px;">
			    <span><img width="100px" height="75px" src="images/brand/${car.carPic }" /></span>
			    <h2><a href="findtodetails?id=${car.carId }"></a></h2>
